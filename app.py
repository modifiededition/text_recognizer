...
#DEFAULT_URL = "http://0.0.0.0:8080/encode/"
...
def make_frontend(
    ...
    examples_dir = APP_DIR / Path("data") / "processed" / "iam_paragraphs" /"train"
    example_fnames = [elem for elem in os.listdir(examples_dir) if elem.endswith(".png")][:5]
